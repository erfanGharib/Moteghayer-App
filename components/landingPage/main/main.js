        ...
        <main className='w-full mt-20 f-col-center'>
            ...
            <div className='w-full f-center h-52 relative moteghayer-gradient overflow-hidden'>
                <Image
                    ...
                    style={{ height: '130%', width: '30%' }}
                />
                <Image
                    src={layerImg}
                    alt='layer'
                    className='absolute -top-20 -right-14 transform rotate-180'
                    style={{ height: '130%', width: '30%' }}
                />
                <div className='f-col-center'>
                    <h3 className='font-extrabold text-black-800 mb-4 text-2xl'>آماده شروع یک تغییر هستید؟</h3>
